...
import com.ts.alex.mynews.data.datasource.impl.JobDataSource
...
import com.ts.alex.mynews.data.repository.JobRepository
...
val singleModule = module {
    viewModel { MainViewModel(getNews = get(), db = get(), preferences = get(), job = get()) }
